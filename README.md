...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  Lcd_cursor(&lcd, 0,1);
	  Lcd_string(&lcd, "vishnu\n");
	  HAL_Delay(100);
	  Lcd_cursor(&lcd, 1,0);
	  for(int x=0;x<1;x++)
	  {
		  Lcd_string(1,0);
		  Lcd_string(&lcd, "212221230023");
	   HAL_Delay (200);
...
## Output screen shots of proteus  :
 ![image](https://github.com/vishnudorigundla/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/94175324/bfa5eb39-2863-4b7a-9752-f31ebcbcdea5)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/vishnudorigundla/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/94175324/af89d758-08ae-4b30-a87c-0b9b5aae6d95)
